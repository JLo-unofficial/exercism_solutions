...
describe("Triplet", () => {
  ...
  it.ignore("triplets whose sum is 108", () => {
    assertEquals(tripletsWithSum(108), [[27, 36, 45]]);
  });

  it.ignore("triplets whose sum is 1000", () => {
    assertEquals(tripletsWithSum(1000), [[200, 375, 425]]);
  });

  it.ignore("no matching triplets for 1001", () => {
    assertEquals(tripletsWithSum(1001), []);
  });

  it.ignore("returns all matching triplets", () => {
  ...
  it.ignore("several matching triplets", () => {
  ...
  it.ignore("returns triplets with no factor smaller than minimum factor", () => {
    assertEquals(tripletsWithSum(90, { minFactor: 10 }), [[15, 36, 39]]);
  });

  it.ignore("returns triplets with no factor larger than maximum factor", () => {
    assertEquals(tripletsWithSum(840, { maxFactor: 349 }), [[240, 252, 348]]);
  });

  it.ignore("returns triplets with factors in range", () => {
  ...
  it.ignore("triplets for large number", () => {
